(function(root, factory) {
  ...
  var cv = function(cv) {
      ...
      var Module;
      if (!Module)
          Module = (typeof cv !== "undefined" ? cv : null) || {};
      var moduleOverrides = {};
      ...
      memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "opencv_js.js.mem" : null;
      ...
      function ___cxa_find_matching_catch() {
          ...
          for (var i = 0; i < typeArray.length; i++) {
              if (typeArray[i] && Module["___cxa_can_catch"](typeArray[i], throwntype, thrown)) {
                  ...
                  return (Runtime.setTempRet0(typeArray[i]),
                  thrown) | 0
              }
          }
          thrown = HEAP32[thrown >> 2];
          return (Runtime.setTempRet0(throwntype),
          thrown) | 0
      }
